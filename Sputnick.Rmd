...
## The fisher exact test is an odds-ratio test. It is commonly used in clinical trials to test the effectiveness of preventitive drugs like vaccines. In this case it says the odds of getting covid is 11.96 times greater if you had taken the placebo than if you had taken the vaccine. The media is reporting this as 92% effective. It also gives you a confidence interval that has the true odds ratio within it 95% of the time.  That interval is 6.8 to 22.24. To turn odds in probability p=odds/1+odds

```{r}
effectiveness =  11.96541 /( 11.96541  +1)
print(effectiveness*100)
```
# Conclusion effectiveness is simply turning odds (in this case an odds_ratio) into a percentage If the odds of something happening is O, then the probability of it happening is O/(1 + O). To turn probability to a percent just multiply by 100.
