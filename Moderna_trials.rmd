...
## The fisher exact test is an odds-ratio test. It is commonly used in clinical trials to test the effectiveness of preventitive drugs like vaccines. In this case it says the odds of getting covid is 17.01 times greater if you had taken the placebo than if you had taken the vaccine. The media is reporting this as 95% effective. It also gives you a confidence interval that has the true odds ratio within it 95% of the time. That interval is 9.28 to 34.70. To turn odds in probability p=odds/1+odds 

```{r}
effectiveness =  17.01454  /( 17.01454   +1)
print(effectiveness*100)
```

```{r}
low=(9.28/(9.28 + 1))*100
hi=(34.70/(34.70 +1))*100
options(digits=2)
```
